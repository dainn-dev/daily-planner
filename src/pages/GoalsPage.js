  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: 'Chúc mừng! Bạn đã đạt 75% tiến độ mục tiêu "Tiết kiệm 200 triệu".',
      time: '1 giờ trước',
      unread: true,
      icon: 'emoji_events',
      iconBg: 'bg-green-100',
    ...
    },
    {
      ...
      message: 'Đừng quên cập nhật tiến độ mục tiêu "Học React Native" hôm nay.',
      time: '3 giờ trước',
      unread: true,
    ...
    },
    {
      ...
      message: 'Tính năng theo dõi mục tiêu mới đã được cập nhật.',
      time: 'Hôm qua',
      unread: false,
      icon: 'settings',
      iconBg: 'bg-gray-100',
  ...
  const handleAddGoal = (e) => {
    ...
    if (hasErrors) {
      ...
      const newGoal = {
        ...
        dueDate: goalForm.dueDate || new Date().toLocaleDateString('vi-VN'),
        progress: 0,
        icon: goalForm.icon,
        status: 'active'
      };
