          ...
          <div className="max-w-7xl flex-1 flex flex-col gap-8 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex flex-col gap-3 rounded-xl bg-white p-5 shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#111418]">12,450</p>
                  <p className="text-emerald-600 text-sm font-medium flex items-center gap-1 mt-1">
                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                    +5% <span className="text-gray-400 font-normal">vs last month</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 rounded-xl bg-white p-5 shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#111418]">1,203</p>
                  <p className="text-emerald-600 text-sm font-medium flex items-center gap-1 mt-1">
                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
                    +12% <span className="text-gray-400 font-normal">vs yesterday</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 rounded-xl bg-white p-5 shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="text-2xl font-bold text-[#111418]">3,200</p>
                  <p className="text-emerald-600 text-sm font-medium flex items-center gap-1 mt-1">
                    <span className="material-symbols-outlined text-[16px]">trending_up</span>
              ...
              <div className="flex flex-col gap-3 rounded-xl bg-white p-5 shadow-sm border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-rose-500 text-sm font-medium flex items-center gap-1 mt-1">
                    <span className="material-symbols-outlined text-[16px]">trending_down</span>
                    -1% <span className="text-gray-400 font-normal">vs last week</span>
                  </p>
                </div>
              </div>
            </div>
