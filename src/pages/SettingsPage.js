...
const SettingsPage = () => {
  ...
  const [notifications, setNotifications] = useState([
      ...
      message: 'Cài đặt của bạn đã được lưu thành công.',
      time: '10 phút trước',
      unread: true,
      icon: 'settings',
      iconBg: 'bg-blue-100',
      ...
      message: 'Đã phát hiện đăng nhập từ thiết bị mới. Hãy xác nhận nếu đó là bạn.',
      time: '1 giờ trước',
      unread: true,
      icon: 'security',
    ...
    },
    {
      ...
      message: 'Phiên bản mới đã có sẵn. Cập nhật để trải nghiệm tính năng mới.',
      time: 'Hôm qua',
      unread: false,
      icon: 'info',
      iconBg: 'bg-gray-100',
    ...
    <div className="relative flex h-screen w-full overflow-hidden bg-background-subtle text-zinc-900 antialiased selection:bg-zinc-200">
      ...
      <main className="flex-1 flex flex-col h-full overflow-y-auto relative bg-background-subtle">
        ...
        <div className="w-full max-w-[1000px] mx-auto px-6 sm:px-10 py-10 flex flex-col md:flex-row gap-12">
          ...
          <aside className="w-full md:w-64 shrink-0 flex flex-col gap-8 md:hidden">
